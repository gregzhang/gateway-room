...
namespace Goodish\GatewayRoom\Events;
...
class BusinessEvents
{
     ...
     */
    static function onWorkerStart(BusinessWorker $businessWorker)
    {
...
//        }
     ...
     * @param BusinessWorker $businessWorker
     */
    static function onWorkerStop(BusinessWorker $businessWorker)
    {
//        echo "WorkerStop\n";
    }
